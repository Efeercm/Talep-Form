...
namespace talepformu
{
    public partial class talepListele : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                KisiDropDownDoldur();
                VerileriGetir(); // Sayfa açıldığında tüm talepleri getir

                // Datalist ilişkilendirme
        ...
        protected void btnSecilenleriSil_Click(object sender, EventArgs e)
        {
            ...
            if (idList.Count > 0)
            {
                ...
                VerileriGetir(txtSap.Text.Trim(), ddlKisi.SelectedValue); // Listeyi yenile
            }
        }

        // Tüm checkboxları seçmek için header checkbox eventi:
